...
<div style={{backgroundColor: '#00A4FF',  width: '170px', height: '35px', lineHeight: '35px', textAlign: 'center'}}><a href="https://apaas.cloud.tencent.com/sign/apply" target="_blank" style={{color: 'white', fontSize: '16px'}}>填写使用申请</a></div>
